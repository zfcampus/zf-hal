...
return [
    ...
    'service_manager' => [
        'factories' => [
            ...
            'ZF\Hal\HalConfig'         => Factory\HalConfigFactory::class,
            'ZF\Hal\JsonRenderer'      => Factory\HalJsonRendererFactory::class,
            'ZF\Hal\JsonStrategy'      => Factory\HalJsonStrategyFactory::class,
            Link\LinkUrlBuilder::class => Factory\LinkUrlBuilderFactory::class,
            'ZF\Hal\MetadataMap'       => Factory\MetadataMapFactory::class,
